        ...
        function mostrarFormulario (editar = false, tarea = {}) {
           ...
           modal.innerHTML = `
                <form class="formulario nueva-tarea">
                    ...
                    <div class="campo">
                        <label>Tarea</label>
                        <input type="text" name="tarea" placeholder="${tarea.nombre ? 'Editar Tarea' : 'Añadir al Proyecto Actual'}" id="tarea" value="${tarea.nombre ? tarea.nombre : ''}" />
                    </div>
                    <div class="opciones">
                        <input type="submit" class="submi-nueva-tarea" value="${tarea.nombre ? 'Guardar Cambios' : 'Añadir Tarea'}" />
